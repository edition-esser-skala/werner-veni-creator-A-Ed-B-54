...
\lastname{Werner}
\title{Veni creator Spiritus}
\shorttitle{Veni creator}
\subtitle{(A-Ed B 54)}
\scoring{T (solo), S, A, T, B (coro), 2 vl, b, org}
\maketitle
...
This edition bases upon a copy in the Dommusikarchiv Eisenstadt. The digital version of the manuscript is available at \url{http://dommusikarchiv.martinus.at/site/werkverzeichnis/gallery/784.html} (siglum B 54; see also RISM ID 600038025).
...
\begin{longtable}{ll L{10cm}}
  ...
  \midrule \endhead
  4  & org & 2nd/3rd half note as in vlne; in org: r2–r2 \\
  83 & org & bar in Ms: F2–r4 \\
  97 & org & 3rd quarter as in vlne; in org: G8–r8 \\
  \bottomrule
\end{longtable}


This edition has been compiled and checked with utmost diligence. Nevertheless, errors and mistakes cannot be totally excluded. Please report any errors and mistakes to \url{wolfgang@esser-skala.at} or create an issue or pull request on the edition’s GitHub page \url{https://github.com/skafdasschaf/werner-veni-creator-A-Ed-B-54}. Your help will be greatly appreciated.
